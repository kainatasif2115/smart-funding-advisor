    ...
    <div className="min-h-screen relative">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold text-gray-200 mb-2">Review & Add Company</h1>
          <p className="text-gray-100">Verify the AI-generated information and make any necessary edits</p>
        </motion.div>
